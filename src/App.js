    ...
    return (
      <Router>
        <div>
          ...
          <Route path="/catalog" exact render={() => <Catalog searchInput={this.state.searchInput} handleInput={this.handleInput} movies={this.state.movies} toggleRented={this.toggleRented} />} />
